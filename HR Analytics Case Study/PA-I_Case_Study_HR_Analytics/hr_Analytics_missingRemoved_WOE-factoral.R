...
emp_reduced <- emp_no_na[,c(2,3,4,5,6,7,8,9,11,14,15,16,17,20,21,22,23,24)]


# converting BusinessTravel into factor.
# Converting "BusinessTravel" into dummies . 
emp_reduced$BusinessTravel <- as.factor(emp_reduced$BusinessTravel)
dummy_BusinessTravel <- data.frame(model.matrix( ~BusinessTravel, data = emp_reduced))
...
emp_reduced <- cbind(emp_reduced[,-6], dummy_BusinessTravel)


# converting Department into factor.
# Converting "Department" into dummies . 
emp_reduced$Department <- as.factor(emp_reduced$Department)
dummy_Department <- data.frame(model.matrix( ~Department, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_Department <- dummy_Department[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-6], dummy_Department)


# converting EducationField into factor.
# Converting "EducationField" into dummies . 
emp_reduced$EducationField <- as.factor(emp_reduced$EducationField)
dummy_EducationField <- data.frame(model.matrix( ~EducationField, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_EducationField <- dummy_EducationField[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-7], dummy_EducationField)



# converting JobRole into factor.
# Converting "JobRole" into dummies . 
emp_reduced$JobRole <- as.factor(emp_reduced$JobRole)
dummy_JobRole <- data.frame(model.matrix( ~JobRole, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_JobRole <- dummy_JobRole[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-7], dummy_JobRole)


# converting MaritalStatus into factor.
# Converting "MaritalStatus" into dummies . 
emp_reduced$MaritalStatus <- as.factor(emp_reduced$MaritalStatus)
dummy_MaritalStatus <- data.frame(model.matrix( ~MaritalStatus, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_MaritalStatus <- dummy_MaritalStatus[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-7], dummy_MaritalStatus)


# Correlation Matrix:
cor_matrix_dataframe <- emp_reduced
...
pca_fact <- princomp(emp_reduced)
# shows 10 factors should be required
plot(pca_fact)

# find factors
factor_df <- factanal(emp_reduced, factors = 10,rotation = "varimax",lower=.1)
...
quantile(emp_reduced$MonthlyIncome,seq(0,1,.01))
# jump at 90% to 91%, replacing all greater than 137756.0 with 137756.0
emp_reduced$MonthlyIncome[which(emp_reduced$MonthlyIncome>137756.0)] <- 137756.0
...
emp_reduced$TotalWorkingYears <- as.factor(emp_reduced$TotalWorkingYears)

# for coarse classing, compute WOE for 5,6 and 7 values 
TotalWorkingYears_567 <- emp_reduced[which(emp_reduced$TotalWorkingYears>=5 & emp_reduced$TotalWorkingYears<=7),c(9,5)]
...
emp_reduced$TotalWorkingYears <- as.numeric(emp_reduced$TotalWorkingYears)
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=0 & emp_reduced$TotalWorkingYears<=2)] <- '0-2'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=3 & emp_reduced$TotalWorkingYears<=4)] <- '3-4'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=5 & emp_reduced$TotalWorkingYears<=7)] <- '5-7'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=8 & emp_reduced$TotalWorkingYears<=9)] <- '8-9'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=10 & emp_reduced$TotalWorkingYears<=12)] <- '10-12'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=13 & emp_reduced$TotalWorkingYears<=16)] <- '13-16'
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=17 & emp_reduced$TotalWorkingYears<=22)] <- '17-22'

# replace all values greater than 23 years with 23+ years 
emp_reduced$TotalWorkingYears[which(emp_reduced$TotalWorkingYears>=23)] <- '23+'
...
emp_reduced$YearsAtCompany <- as.numeric(emp_reduced$YearsAtCompany)

# check quantile distribution for YearsAtCompany 
quantile(emp_reduced$YearsAtCompany,seq(0,1,.01))
# for coarse classing, compute WOE 0,1
YearsAtCompany_01 <- emp_reduced[which(emp_reduced$YearsAtCompany==0 | emp_reduced$YearsAtCompany==1),c(11,5)]
...
YearsAtCompany_5678 <- emp_reduced[which(emp_reduced$YearsAtCompany>=7 & emp_reduced$YearsAtCompany<=14 ),c(11,5)]
...
temp_yrs <- emp_reduced$YearsAtCompany
emp_reduced$YearsAtCompany[which(temp_yrs>=0 & temp_yrs<=1)] <- '0-1'
emp_reduced$YearsAtCompany[which(temp_yrs>=3 & temp_yrs<=4)] <- '3-4'
emp_reduced$YearsAtCompany[which(temp_yrs>=5 & temp_yrs<=6)] <- '5-6'
emp_reduced$YearsAtCompany[which(temp_yrs>=7 & temp_yrs<=14)] <- '7-14'


# replace all values greater than 15 years with 15+ years 
emp_reduced$YearsAtCompany[which(temp_yrs>=15)] <- '15+'


# check quantile distribution for YearsSinceLastPromotion 
emp_reduced$YearsSinceLastPromotion <- as.numeric((emp_reduced$YearsSinceLastPromotion))
quantile(emp_reduced$YearsSinceLastPromotion,seq(0,1,.01))
...
YearsSinceLastPromotion_123 <- emp_reduced[which(emp_reduced$YearsSinceLastPromotion>=1 & emp_reduced$YearsSinceLastPromotion<=3),c(12,5)]
...
YearsSinceLastPromotion_4_15 <- emp_reduced[which(emp_reduced$YearsSinceLastPromotion>=4 & emp_reduced$YearsSinceLastPromotion<=15),c(12,5)]
...
temp_yrsPromotion <- emp_reduced$YearsSinceLastPromotion
emp_reduced$YearsSinceLastPromotion[which(temp_yrsPromotion>=1 & temp_yrsPromotion<=3)] <- '1-3'

# replace all values greater than 11 years with 4+ years 
emp_reduced$YearsSinceLastPromotion[which(temp_yrsPromotion>=4)] <- '4+'


# check quantile distribution for YearsWithCurrManager 
emp_reduced$YearsWithCurrManager <- as.numeric(emp_reduced$YearsWithCurrManager)
quantile(emp_reduced$YearsWithCurrManager,seq(0,1,.01))
...
YearsWithCurrManager_12 <- emp_reduced[which(emp_reduced$YearsWithCurrManager==1 | 
                                               emp_reduced$YearsWithCurrManager==2),c(13,5)]
...
YearsWithCurrManager_4_8 <- emp_reduced[which(emp_reduced$YearsWithCurrManager>=4 & emp_reduced$YearsWithCurrManager<=8),c(13,5)]
...
temp_yrsCurMgr <- emp_reduced$YearsWithCurrManager
emp_reduced$YearsWithCurrManager[which(temp_yrsCurMgr>=1 & temp_yrsCurMgr<=2)] <- '1-2'
emp_reduced$YearsWithCurrManager[which(temp_yrsCurMgr>=4 & temp_yrsCurMgr<=8)] <- '4-8'

# replace all values greater than 9 years with 9+ years 
emp_reduced$YearsWithCurrManager[which(temp_yrsCurMgr>=9)] <- '9+'


# check quantile distribution for DistanceFromHome 
emp_reduced$DistanceFromHome <- as.numeric(emp_reduced$DistanceFromHome)
quantile(emp_reduced$DistanceFromHome,seq(0,1,.01))
...
DistanceFromHome_11_29 <- emp_reduced[which(emp_reduced$DistanceFromHome>=11 & emp_reduced$DistanceFromHome<=29),c(6,5)]
...
DistanceFromHome_3_10 <- emp_reduced[which(emp_reduced$DistanceFromHome>=3 & emp_reduced$DistanceFromHome<=10),c(6,5)]
...
combined_woe <- computeWoE(loc_good,loc_bad) # -.016

# for coarse classing, comvine 1 till 2 to make WOE tend monotonic
DistanceFromHome_12 <- emp_reduced[which(emp_reduced$DistanceFromHome>=1 & emp_reduced$DistanceFromHome<=2),c(6,5)]
...
emp_reduced$DistanceFromHome[which(temp_dist>=1 & temp_dist<=2)] <- '1-2'
emp_reduced$DistanceFromHome[which(temp_dist>=3 & temp_dist<=10)] <- '3-10'


# replace all values greater than 20  with 20+  
emp_reduced$DistanceFromHome[which(temp_dist>=11)] <- '11+'



# check quantile distribution for DistanceFromHome 
emp_reduced$Age <- as.numeric(emp_reduced$Age)
quantile(emp_reduced$Age,seq(0,1,.01))
boxplot(emp_reduced$Age)
...
Age_26_33 <- emp_reduced[which(emp_reduced$Age>=26 & emp_reduced$Age<=33),c(4,5)]
...
Age_ <- emp_reduced[which(emp_reduced$Age>=34 & emp_reduced$Age<=37),c(4,5)]
...
Age_ <- emp_reduced[which(emp_reduced$Age>=38 & emp_reduced$Age<=60),c(4,5)]
loc_good <- length(Age_$Attrition[which(Age_$Attrition==1)])
loc_bad <- length(Age_$Attrition[which(Age_$Attrition==0)])
...
temp_age <- emp_reduced$Age
emp_reduced$Age[which(temp_age>=18 & temp_age<=25)] <- '18-25'
emp_reduced$Age[which(temp_age>=26 & temp_age<=33)] <- '26-33'
emp_reduced$Age[which(temp_age>=34 & temp_age<=37)] <- '34-37'


# replace all values greater than 38 with 38+  
emp_reduced$Age[which(temp_age>=38)] <- '38+'
...
emp_reduced$EnvironmentSatisfaction <- as.factor(emp_reduced$EnvironmentSatisfaction)
dummy_EnvironmentSatisfaction <- data.frame(model.matrix( ~EnvironmentSatisfaction, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_EnvironmentSatisfaction <- dummy_EnvironmentSatisfaction[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-1], dummy_EnvironmentSatisfaction)


# converting JobSatisfaction into factor.
# Converting "JobSatisfaction" into dummies . 
emp_reduced$JobSatisfaction <- as.factor(emp_reduced$JobSatisfaction)
dummy_JobSatisfaction <- data.frame(model.matrix( ~JobSatisfaction, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_JobSatisfaction <- dummy_JobSatisfaction[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-1], dummy_JobSatisfaction)



# converting WorkLifeBalance into factor.
# Converting "WorkLifeBalance" into dummies . 
emp_reduced$WorkLifeBalance <- as.factor(emp_reduced$WorkLifeBalance)
dummy_WorkLifeBalance <- data.frame(model.matrix( ~WorkLifeBalance, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_WorkLifeBalance <- dummy_WorkLifeBalance[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-1], dummy_WorkLifeBalance)


# converting NumCompaniesWorked into factor.
# Converting "NumCompaniesWorked" into dummies . 
emp_reduced$NumCompaniesWorked <- as.factor(emp_reduced$NumCompaniesWorked)
dummy_NumCompaniesWorked <- data.frame(model.matrix( ~NumCompaniesWorked, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_NumCompaniesWorked <- dummy_NumCompaniesWorked[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-5], dummy_NumCompaniesWorked)


# converting TrainingTimesLastYear into factor.
# Converting "TrainingTimesLastYear" into dummies . 
emp_reduced$TrainingTimesLastYear <- as.factor(emp_reduced$TrainingTimesLastYear)
dummy_TrainingTimesLastYear <- data.frame(model.matrix( ~TrainingTimesLastYear, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_TrainingTimesLastYear <- dummy_TrainingTimesLastYear[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-6], dummy_TrainingTimesLastYear)


# converting TotalWorkingYears into factor.
# Converting "TotalWorkingYears" into dummies . 
emp_reduced$TotalWorkingYears <- as.factor(emp_reduced$TotalWorkingYears)
dummy_TotalWorkingYears <- data.frame(model.matrix( ~TotalWorkingYears, data = emp_reduced))

#This column should be removed from the newly created dummy_carbody dataframe.
dummy_TotalWorkingYears <- dummy_TotalWorkingYears[,-1]

# Combine the dummy variables to the main data set, after removing the original  column
emp_reduced <- cbind(emp_reduced[,-5], dummy_TotalWorkingYears)
