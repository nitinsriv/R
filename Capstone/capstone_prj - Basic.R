...
# year 2015 first week started from 28th Devember 2014.
...
# NPS and Advertisement will be accurately distributed
...
# There are 0 rows with negative values,removing rows with negative values due to their no impact on overall dataset
hom_Audio_df[-which(hom_Audio_df$delcdays < 0),]
...
basic_cam_access_model2 <- lm(Sales ~  PromotionWeek + NPS + sc_Digital + sc_Sponsorship + sc_ContentMarketing, data=b_train)
...
basic_cam_access_model3 <- lm(Sales ~  PromotionWeek + NPS + sc_Digital + sc_Sponsorship , data=b_train)
#basic_cam_access_model2 <- lm(Sales ~ scale_PromotionWeek + scale_Discount + scale_Advertisement, data=train[,c(2,11:14)])
...
par(mfrow=c(2,2))
plot(basic_cam_access_model4)


# Predict the house prices in the testing dataset
Predict_1 <- predict(basic_cam_access_model4,test[,-1])
...
mul_cam_access_model2 <- lm(log(Sales) ~ PromotionWeek + NPS + log(ContentMarketing) ,na.action = na.exclude, data=ln_train)

# Multiple R-squared:  0.9247,	Adjusted R-squared:  0.9176
summary(mul_cam_access_model2) 
vif(mul_cam_access_model2)

mul_cam_access_model3 <- lm(log(Sales) ~ NPS + log(ContentMarketing),na.action = na.exclude, data=ln_train)
...
# plot Residuals vs Fitted
op<-par(mfrow=c(2,2))
plot(mul_cam_access_model3)
par(op)

# Predict the sales in the testing dataset
Predict_1 <- predict(mul_cam_access_model3,test[,-1])
test$log_predicted_sale <- Predict_1


# Calculate RMSE: .4421 on train
ln_RSS_train <- c(crossprod(mul_cam_access_model3$residuals))
ln_RSS_train

ln_MSE_train <- ln_RSS_train / length(mul_cam_access_model3$residuals)
ln_MSE_train
...
ky_cam_access_model2 <- lm(Sales ~  Discount + PromotionWeek + NPS + salesLag + sc_Digital + 
                              sc_Sponsorship + sc_ContentMarketing, data=k_train)
...
ky_cam_access_model3 <- lm(Sales ~   PromotionWeek + NPS + salesLag + sc_Digital + 
                             sc_Sponsorship + sc_ContentMarketing, data=k_train)
...
ky_cam_access_model4 <- lm(Sales ~   PromotionWeek + NPS + salesLag +  
                             sc_Sponsorship + sc_ContentMarketing, data=k_train)
...
# plot Residuals vs Fitted
op <- par(mfrow = c(2, 2))
plot(ky_cam_access_model5)
par(op)

# Predict the house prices in the testing dataset
Predict_1 <- predict(ky_cam_access_model5,test[,-1])
test$ky_predicted_sale <- Predict_1


# Calculate RMSE: 1488007 on train data
ky_RSS_train <- c(crossprod(ky_cam_access_model5$residuals))
ky_RSS_train

ky_MSE_train <- ky_RSS_train / length(ky_cam_access_model5$residuals)
ky_MSE_train
...
# calculate RMSE on test data: 2854138
computeRMSE(test$error)

# calculate r-squared: .00124
...
dis_cam_access_model2 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag + TVLag + SponsorshipLag + 
                              ContentMarketingLag + OnlineLag + AffliatesLag + sc_Sponsorship + 
                              sc_ContentMarketing + sc_Online + sc_SEM + sc_Affliates ,na.action = na.exclude, data=dn_train)

# Multiple R-squared:  0.7255,	Adjusted R-squared:  0.6569
summary(dis_cam_access_model2) 
vif(dis_cam_access_model2)

# dis_cam_access_model3 <- lm(Sales ~  PromotionWeek + NPS + salesLag + sc_Digital + 
#                               sc_Sponsorship + sc_ContentMarketing ,na.action = na.exclude, data=dn_train)
# 
# # Multiple R-squared:  0.5263,	Adjusted R-squared:  0.6445
# summary(dis_cam_access_model3) 
# vif(dis_cam_access_model3)

dis_cam_access_model3 <- lm(Sales ~  Discount + PromotionWeek + NPS + salesLag + TVLag + SponsorshipLag + 
                              ContentMarketingLag + OnlineLag + AffliatesLag + sc_Sponsorship + 
...
# dis_cam_access_model4 <- lm(Sales ~ PromotionWeek + NPS + salesLag +  
#                               sc_Sponsorship + sc_ContentMarketing,na.action = na.exclude, data=dn_train)
# 
# # Multiple R-squared:  0.609,	Adjusted R-squared:  0.5438
...
dis_cam_access_model4 <- lm(Sales ~  Discount + PromotionWeek + NPS + salesLag +  SponsorshipLag + 
                              ContentMarketingLag + OnlineLag + AffliatesLag + sc_Sponsorship + 
                              sc_Online + sc_SEM + sc_Affliates,na.action = na.exclude, data=dn_train)
...
# dis_cam_access_model5 <- lm(Sales ~ PromotionWeek + NPS + salesLag +  
#                               sc_Sponsorship ,na.action = na.exclude, data=dn_train)
# 
# # Multiple R-squared:  0.6065,	Adjusted R-squared:  0.5557
# summary(dis_cam_access_model5) 
# vif(dis_cam_access_model5)

dis_cam_access_model5 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +  ContentMarketingLag + OnlineLag + AffliatesLag + sc_Sponsorship + 
                              sc_Online + sc_SEM + sc_Affliates ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model6 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +  ContentMarketingLag + OnlineLag +  sc_Sponsorship + 
                              sc_Online + sc_SEM + sc_Affliates ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model7 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +  ContentMarketingLag +   sc_Sponsorship + 
                              sc_Online + sc_SEM + sc_Affliates ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model8 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +  ContentMarketingLag +   sc_Sponsorship + 
                              sc_Online + sc_SEM  ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model9 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +   sc_Sponsorship + 
                              sc_Online + sc_SEM  ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model10 <- lm(Sales ~ Discount + PromotionWeek + NPS + salesLag +   sc_Sponsorship + 
                              sc_Online   ,na.action = na.exclude, data=dn_train)

# Multiple R-squared:  0.6065,	Adjusted R-squared:  0.5557
summary(dis_cam_access_model10) 
vif(dis_cam_access_model10)

dis_cam_access_model11 <- lm(Sales ~ PromotionWeek + NPS + salesLag +   sc_Sponsorship + 
                               sc_Online   ,na.action = na.exclude, data=dn_train)
...
dis_cam_access_model12 <- lm(Sales ~ PromotionWeek + NPS + salesLag +   sc_Sponsorship ,na.action = na.exclude, data=dn_train)
...
# plot Residuals vs Fitted
op <- par(mfrow = c(2, 2))
plot(dis_cam_access_model12)
par(op)

# Predict the house prices in the testing dataset
Predict_1 <- predict(dis_cam_access_model12,test[,-1])
test$dy_predicted_sale <- Predict_1


# Calculate RMSE: 1488007 on train data
dy_RSS_train <- c(crossprod(dis_cam_access_model12$residuals))
dy_RSS_train

dy_MSE_train <- dy_RSS_train / length(dis_cam_access_model12$residuals)
dy_MSE_train
...
# plot Residuals vs Fitted
op <- par(mfrow = c(2, 2))
plot(mx_cam_access_model1)
par(op)


# Predict the sales in the testing dataset
Predict_1 <- predict(mx_cam_access_model1,test[,-1])
test$lmx_predicted_sale <- Predict_1


# Calculate RMSE: 0.4279181 on train data (log scale)
mx_RSS_train <- c(crossprod(mx_cam_access_model1$residuals))
mx_RSS_train

mx_MSE_train <- mx_RSS_train / length(mx_cam_access_model1$residuals)
mx_MSE_train
...
# calculate RMSE on test data: 1751585
computeRMSE(test$error)
...
# plot Residuals vs Fitted
op<-par(mfrow=c(2,2))
plot(mul_gam_access_model9)
par(op)

# Predict the sales in the testing dataset
Predict_1 <- predict(mul_gam_access_model9,test[,-1])
test$log_predicted_sale <- Predict_1


# Calculate RMSE: 1.07 on train
ln_RSS_train <- c(crossprod(mul_gam_access_model9$residuals))
ln_RSS_train

ln_MSE_train <- ln_RSS_train / length(mul_gam_access_model9$residuals)
ln_MSE_train
...
# Calculate RMSE: 836296 on train data
...
# Multiple R-squared:  0.6871,	Adjusted R-squared:  0.2491
...
wk_hom_Audio$salesLag <- scale(wk_hom_Audio$salesLag, center = FALSE, scale = TRUE)
wk_hom_Audio$TVLag <- scale(wk_hom_Audio$TVLag, center = FALSE, scale = TRUE)
wk_hom_Audio$DigitalLag <- scale(wk_hom_Audio$DigitalLag, center = FALSE, scale = TRUE)
wk_hom_Audio$SponsorshipLag <- scale(wk_hom_Audio$SponsorshipLag, center = FALSE, scale = TRUE)
wk_hom_Audio$ContentMarketingLag <- scale(wk_hom_Audio$ContentMarketingLag, center = FALSE, scale = TRUE)
wk_hom_Audio$OnlineLag <- scale(wk_hom_Audio$OnlineLag, center = FALSE, scale = TRUE)
wk_hom_Audio$SEMLag <- scale(wk_hom_Audio$SEMLag, center = FALSE, scale = TRUE)
wk_hom_Audio$AffliatesLag <- scale(wk_hom_Audio$AffliatesLag, center = FALSE, scale = TRUE)


#wk_hom_Audio$salesLag <- wk_hom_Audio$salesLag - (.4*(wk_hom_Audio^2) + .3*wk_hom_Audio$salesLag)

dfMod_hom_acces <- wk_hom_Audio
...
# Multiple R-squared:  0.6723,	Adjusted R-squared:  0.5084
...
ln_train <- train[,c(2:15)]
mul_hom_audio_model1 <- lm(log(Sales) ~ PaymentType + PromotionWeek + Discount + delbdays + delcdays +NPS + log(TV) + log(Digital) 
                            + log(Sponsorship) + log(ContentMarketing) + log(Online) + log(SEM) + log(Affliates),na.action = na.exclude, data=ln_train)
...
ky_hom_access_model2 <- lm(Sales ~   Discount + PromotionWeek + NPS + salesLag + sc_ContentMarketing + 
...
ky_hom_access_model3 <- lm(Sales ~   Discount + PromotionWeek + NPS + salesLag + sc_ContentMarketing , data=k_train)
...
mx_hom_audio_model1 <- lm(log(Sales) ~ sc_Affliates*sc_Sponsorship,na.action = na.exclude, data=train[,c(2,25:38)])
